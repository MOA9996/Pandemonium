...
export default function Create() {
    const { data, setData, post, processing, errors } = useForm({
        titulo: '', descripcion: '', activo: false, fotos: [],
    });
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        post(route('lookbook.store'), { forceFormData: true });
    };
                ...
                <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                        ...
                        <label htmlFor="activo" style={{ color: '#555', fontSize: '10px', letterSpacing: '0.15em', textTransform: 'uppercase', cursor: 'pointer' }}>
                            Activar este lookbook al crearlo
                        </label>
                    </div>
                    ...
                    <div>
                        ...
                        <p style={{ color: '#444', fontSize: '11px', marginBottom: '10px' }}>Puedes seleccionar varias imágenes a la vez.</p>
                        <label
                            ...
                            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '8px', marginTop: '12px' }}>
                                {previews.map((src, i) => (
                                    ...
                                    >
                                        ...
                                        <button type="button" className="btn-q" onClick={() => quitarFoto(i)}
                    ...
                    >
                        {processing ? 'Guardando...' : 'Crear lookbook'}
                    </button>
                </form>
            </div>
        </AuthenticatedLayout>
