    ...
    return (
        <AuthenticatedLayout>
            <div className="max-w-2xl mx-auto py-6 px-4">
                ...
                <h1 className="text-2xl font-bold mb-6">Nuevo Lookbook</h1>
                ...
                <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        />
                        <label htmlFor="activo" className="text-sm">Activar este lookbook al crearlo</label>
                    </div>
                    ...
                    <div>
                        ...
                        <input
                            ...
                            className="border rounded px-3 py-2 w-full"
                        />
                        {errors.fotos && <p className="text-red-500 text-sm">{errors.fotos}</p>}
                    </div>
